...
[Function Calling](https://platform.openai.com/docs/guides/function-calling#function-calling-with-structured-outputs) guide.
...
| Compatible models  | gpt-4o-mini, gpt-4o-2024-08-06, and later                                | gpt-3.5-turbo, gpt-4-x and gpt-4o-x models |
...
```json
{
	...
	"keywords": ["Quantum algorithms", "interstellar navigation", "space-time anomalies", "quantum superposition", "quantum entanglement", "space travel"]
}
```
